...
<div class="chat js-chat">
    <div class="chat__messenger">
        ...
        <a href="mailto:info@prof1group.com" class="chat__messenger-item">
            <img src="/images/chat-messenger/email.svg" alt="icon E-mail" class="chat__messenger-icon">
        ...
        <a href="http://m.me/prof1groupcompany" class="chat__messenger-item" target="_blank" rel="noopener">
            <img src="/images/chat-messenger/facebook.svg" alt="icon Facebook" class="chat__messenger-icon">
        ...
        <a href="viber://chat?number=+380506595979" class="chat__messenger-item">
            <img src="/images/chat-messenger/viber.svg" alt="icon Viber" class="chat__messenger-icon">
            <span class="chat__messenger-name">Написать в Viber</span>
        </a>
        <a href="skype:bb77eb6704f389f5?chat" class="chat__messenger-item">
            <img src="/images/chat-messenger/skype.svg" alt="icon Skype" class="chat__messenger-icon">
        ...
        <a href="tg://resolve?domain=Prof1_site" class="chat__messenger-item" target="_blank" rel="noopener">
            <img src="/images/chat-messenger/telegram.svg" alt="icon Telegram" class="chat__messenger-icon">
        ...
        <a href="https://wa.me/+380506595979" class="chat__messenger-item" target="_blank" rel="noopener">
            <img src="/images/chat-messenger/whatsapp.svg" alt="icon WhatsApp" class="chat__messenger-icon">
            <span class="chat__messenger-name">Написать в WhatsApp</span>
        </a>
    </div>
    <div class="chat__icon">
        <img src="/images/chat-messenger/chat.svg" alt="icon live chat is open" class="chat__icon-message">
        <img src="/images/chat-messenger/cross.svg" alt="icon live chat is closed" class="chat__icon-close">
    </div>
</div>